...
func checkEnvVar(envVar string, required bool) (string, error) { //nolint:unused // Useful function to keep right now, though it's not used. I'll move to a build helpers package or somethign in the future.
