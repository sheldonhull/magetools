...
import (
	...
	_ "github.com/mfridman/tparse"                          // Tparse provides nice formatted go test console output
	_ "github.com/pterm/pterm"                              // Pterm is for cross-platform terminal output.
	_ "github.com/rakyll/gotest"                            // Gotest is a wrapper for running Go tests via command line with support for colors to make it more readable.
	...
	_ "github.com/sheldonhull/magetools/pkg/magetoolsutils" // magetoolsutils handles basic check for identifying if CI in azure-devops, github, or general debug as well as flipping logging status.
	_ "github.com/sheldonhull/magetools/pkg/req"            // Req handles calling go tooling from github primarily and if the tool can't be found installs and returns path of binary.
